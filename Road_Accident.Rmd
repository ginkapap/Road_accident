...
preds_dtree
confusionMatrix(preds_dtree, good_observed, positive='1')
```

## k-Nearest Neighbor Classification
```{r}
results_knn = train(accident_severity~., 
                    data=df_train, 
                    method='knn',
                    trControl=cv_opts10,
                    )
preds_knn = predict(results_knn,df_test)
preds_knn
confusionMatrix(preds_knn, good_observed, positive='1')
```
## Bagging
```{r}
